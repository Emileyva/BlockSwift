    ...
    <section className="pb-20 bg-black">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Card Liquidez */}
          <div 
            className="relative p-8 rounded-2xl overflow-hidden backdrop-blur-sm "
            style={{
          ...
          {/* Card Rapidez */}
          <div 
            className="relative p-8 rounded-2xl overflow-hidden backdrop-blur-sm  md:col-span-2 lg:col-span-1"
            style={{
